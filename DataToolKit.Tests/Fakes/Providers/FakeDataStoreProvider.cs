...
namespace DataToolKit.Tests.Fakes.Providers
{
    ...
    public class FakeDataStoreProvider : IDataStoreProvider
    {
        ...
        {
            // Suche zuerst nach Persistent, dann nach InMemory
            ...
            bool autoLoad = true) where T : class
        {
            ...
            // Repository-Auswahl wie im Original DataStoreProvider
            IRepositoryBase<T> repository;
            if (typeof(IEntity).IsAssignableFrom(typeof(T)))
            {
                // LiteDB für IEntity-Typen
        ...
        public bool RemoveSingleton<T>() where T : class
        {
            ...
            // Entferne beide möglichen Singleton-Typen
